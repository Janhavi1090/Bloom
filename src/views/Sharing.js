  ...
  return (
    <div className="home-container">
      ...
      <header data-thq="thq-navbar" className="home-navbar">
        <span className="home-logo">Bloom</span>
        <div
        ...
        >
          ...
          >
            ...
            <a  href="/Bloom" className="home-button1 button-clean button">
              Single Transaction
            </a>
      ...
      <label className='home-button7 button'>Total Bloom NFT's Minted: {address_mints}
      </label>
      </div>
    ...
    <div class="home-hero">
      <label className='home-button7 button'>Total NFT's Received from Bloom: {address_mints}
      </label>
    </div>
          ...
          <div className="home-description01">
            <div className="home-content">
              ...
              <p className="home-paragraph1">
                Bloom is set to release on public blockchain Layer2. The first
            ...
            <div className="home-main1">
              <div className="home-content02">
                <h2 className="home-header02">
                  Bloom : provides digital and decentralized certification
                  authority
                </h2>
